...
init_db_query = f'''
    ...
    (topic41:TOPIC {{ _id: '{uuid4()}', topic_name: '1. Stavba atomu, atomové jádro, stavba elektronového obalu', topic_content: 
    '<h2 style="text-align:start;"><span style="color: rgb(0,0,0);font-family: Times;">Stavba atomu</span></h2><p style="text-align:justify;"><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">Atom je <ins>nejmenší chemicky nedělitelná částice hmoty</ins>. Atom se skládá z </span><span style="color: rgb(0,0,0);background-color: rgb(247,218,100);font-size: 11pt;font-family: Times New Roman;">kladně nabitého</span><span style="background-color: rgb(247,218,100);"> </span><span style="color: rgb(0,0,0);background-color: rgb(247,218,100);font-size: 11pt;font-family: Times New Roman;">jádra</span> <span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">a z </span><span style="color: rgb(0,0,0);background-color: rgb(247,218,100);font-size: 11pt;font-family: Times New Roman;">elektronového obalu</span><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">, v němž se nacházejí <strong>záporně nabité elektrony</strong>. V neutrálním atomu se kladný náboj jádra a záporný náboj elektronů navzájem <em>kompenzují</em>.</span></p><p></p><img src="https://slideplayer.cz/slide/3310735/11/images/2/Model+atomu+J%C3%A1dro+atomu+Obal+atomu+Proton+p%2B+%28+1%2C+kg%29.jpg" alt="undefined" style="height: auto;width: 500px"/><p></p><h5 style="text-align:justify;"><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">Struktura atomového jádra</span></h5><p style="text-align:justify;"><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">Atomová jádra všech prvků jsou složena z kladně nabitých</span> <span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">protonů</span> <span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">a částic bez náboje -</span> <span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">neutronů. Oba typy částic souhrnně nazýváme nukleony. Základní charakteristiky nukleonů uvádí tabulka. Poněvadž hmotnosti nukleonů jsou mnohonásobně vyšší než hmotnosti elektronů, je hmotnost atomu soustředěna v jádře; hmotnost elektronového obalu činí kolem 1 % hmotnosti atomu.</span></p><ul><li><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">Proton</span></li><li><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">Neutron</span></li><li><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">Elektron</span></li></ul><h5 style="text-align:justify;"><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">Struktura elektronového obalu</span></h5><p style="text-align:justify;"><span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">V</span> <span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">elektroneutrálním</span> <span style="color: rgb(0,0,0);font-size: 11pt;font-family: Times New Roman;">atomu je počet elektronů roven počtu protonů. Elektrony se vyskytují v elektronovém obalu, který obklopuje atomové jádro. Elektronový obal zabírá většinu prostoru atomu, ale podílí se jen nepatrně na celkové hmotnosti atomu.</span></p>',
    date_created: "{random_time()}", date_modified: "{random_time()}" }}) -[:TOPIC_OF]-> (material4),
